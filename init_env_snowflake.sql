...
SET ENV = 'DEV'; -- Changez cette valeur pour 'PROD' ou 'TST' selon l'environnement souhaité
...
GRANT OWNERSHIP ON ALL TABLES IN SCHEMA DPF_SNAPSHOT TO ROLE IDENTIFIER($ROLE_RW_ALL) REVOKE CURRENT GRANTS;
...
GRANT USAGE ON WAREHOUSE dbt_wh TO ROLE IDENTIFIER($ROLE_RW_ALL);
